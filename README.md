...
Right now, I'm working on a low-code platform at [Torus Innovations](https://toruslowcode.com) where users can build apps using drag-and-drop interfaces. I’ve built UI systems, visual editors, and backend logic that helps turn diagrams into working code.
